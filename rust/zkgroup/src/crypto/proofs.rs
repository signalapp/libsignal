...
#[derive(Serialize, Deserialize, Clone)]
pub struct PniCredentialPresentationProof {
    C_x0: RistrettoPoint,
    C_x1: RistrettoPoint,
    C_y1: RistrettoPoint,
    C_y2: RistrettoPoint,
...
impl PniCredentialIssuanceProof {
    ...
    pub fn new(
        ...
        scalar_args.add("y3", key_pair.y[2]);
        scalar_args.add("y4", key_pair.y[3]);
        scalar_args.add("y5", key_pair.y[4]);
        scalar_args.add("y6", key_pair.y[5]);
        scalar_args.add("rprime", blinded_credential.rprime);
        ...
        point_args.add("G_y3", credentials_system.G_y[2]);
        point_args.add("G_y4", credentials_system.G_y[3]);
        point_args.add("G_y5", credentials_system.G_y[4]);
        point_args.add("G_y6", credentials_system.G_y[5]);
        point_args.add("S1", blinded_credential.S1);
        point_args.add("D1", request.D1);
        point_args.add("E1", request.E1);
        point_args.add("S2", blinded_credential.S2);
...
impl PniCredentialPresentationProof {
    pub fn get_poksho_statement() -> poksho::Statement {
        let mut st = poksho::Statement::new();
        st.add("C_z", &[("z", "G_z")]);
        st.add("Z", &[("z", "I")]);
    ...
    pub fn new(
        ...
        let C_y3 = z * credentials_system.G_y[2] + profile_key.M3;
        let C_y4 = z * credentials_system.G_y[3] + profile_key.M4;
        let C_y5 = z * credentials_system.G_y[4] + pni.M1;
        let C_y6 = z * credentials_system.G_y[5] + pni.M2;
