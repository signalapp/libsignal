...
impl<'a> PreKeyStore for JniPreKeyStore<'a> {
    async fn get_pre_key(&self, prekey_id: u32) -> Result<PreKeyRecord, SignalProtocolError> {
    ...
    async fn remove_pre_key(&mut self, prekey_id: u32) -> Result<(), SignalProtocolError> {
