...
pub struct LibSignalProtocolV74(InMemSignalProtocolStore);

impl LibSignalProtocolV74 {
    pub fn new() -> Self {
        let mut csprng = rng();
...
impl super::LibSignalProtocolStore for LibSignalProtocolV74 {
