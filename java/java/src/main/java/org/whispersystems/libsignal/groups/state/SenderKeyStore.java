...
public interface SenderKeyStore {
   ...
   * given (id + senderName + deviceId) tuple.
   *
   * @param senderKeyName the (id + senderName + deviceId) tuple.
   ...
   * corresponding to the (id + senderName + deviceId) tuple, or a new SenderKeyRecord if
