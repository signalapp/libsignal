...
export function SenderKeyName_GetDistributionId(obj: Wrapper<SenderKeyName>): string;
...
export function SenderKeyName_New(distributionId: string, senderName: string, senderDeviceId: number): SenderKeyName;
