...
### Android and Server: GitHub Package Registry

In the signalapp/libsignal repository on GitHub, run the "Publish Java libraries" action on the tag you just made.
